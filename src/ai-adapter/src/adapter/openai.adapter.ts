...
/**
 * OpenAI GPT 어댑터.
 * JSON mode 를 활용하여 구조화된 응답을 강제한다.
 ...
 *
 * 프롬프트 선택은 PromptRegistry 가 담당 (39번 §4). 환경변수 PROMPT_VARIANT 또는
 * OPENAI_PROMPT_VARIANT 로 변형 전환 가능. 미설정 시 default-recommendation 'v2' 사용.
 *
 * Backward compat: USE_V2_PROMPT=true 환경변수는 PromptRegistry 가 globalVariantId='v2' 로 처리
 * (deprecation warning 출력). Sprint 7 에 USE_V2_PROMPT 자체 제거 예정.
 */
@Injectable()
export class OpenAiAdapter extends BaseAdapter {
  ...
  constructor(
    ...
    super(promptBuilder, responseParser, 'OpenAiAdapter', promptRegistry);
