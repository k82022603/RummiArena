...
- **SSOT 참조**: `55-game-rules-enumeration.md` (룰 71개), `57-game-rule-visual-language.md` (시각 언어), `60-ui-feature-spec.md` (기능 스펙 F-NN 25개)
...
게임룰 71개(V-23, UR-36, D-12)가 위반 또는 적용될 때 사용자에게 전달하는 UX 피드백의 **단일 기준**을 정의한다.
