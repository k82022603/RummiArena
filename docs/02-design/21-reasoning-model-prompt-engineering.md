...
- **선행 문서**: `15-deepseek-prompt-optimization.md`, `18-model-prompt-policy.md`
- **실험 보고서**: `04-testing/37-3model-round4-tournament-report.md`, `04-testing/38-v2-prompt-crossmodel-experiment.md`
- **코드 위치**: `src/ai-adapter/src/prompt/v2-reasoning-prompt.ts`
